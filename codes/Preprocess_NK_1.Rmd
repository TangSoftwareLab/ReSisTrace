...
```{r}
bt_sample_path <- "../data/raw/transcriptome/scLT-2-pre-NK-1/"
at_sample_path <- "../data/raw/transcriptome/scLT-2-post-NK-1/"
bt_label_path <- "../data/raw/lineage_label/all_samples/scLT-2-pre-NK-1/adjusted_sequence_count_df.csv"
at_label_path <- "../data/raw/lineage_label/all_samples/scLT-2-post-NK-1/adjusted_sequence_count_df.csv"
...
output_dir <- "../data/output/NK_1/preprocess"
