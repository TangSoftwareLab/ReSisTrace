...
```{r}
bt_sample_path <- "../data/output/cellranger/scLT-ctrl-BT-1/outs/filtered_feature_bc_matrix/"
at_sample_path <- "../data/output/cellranger/scLT-ctrl-AT-1/outs/filtered_feature_bc_matrix/"
bt_label_path <- "../data/output/umi_tools/scLT_ctrl_1/scLT-ctrl-BT-1/adjusted_sequence_count_df.csv"
at_label_path <- "../data/output/umi_tools/scLT_ctrl_1/scLT-ctrl-AT-1/adjusted_sequence_count_df.csv"

output_dir <- "../data/output/scLT_ctrl_1/preprocess/"
...
up.count.bt <- 300000 # Adjust the upper bounder of UMI count here
