...
p <- ggplot(plot_table, aes(x = sample, y = proportion, fill = freq)) +
...
ggsave(paste0(sub_output_dir, "unique_label_per_bt_sample.pdf"), width = 6, height = 5)
```
